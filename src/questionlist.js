export const questionData = [
    ...
    {
        "id": 3,
        "question": "When approaching an intersection and facing a traffic control light that is showing a green right-turn arrow a red light, a driver:",
        "answer": "May proceed when safe, without stopping, in the direction of the arrow",
        "picture": ""
    },
    {
        "id": 4,
        "question": "Alberta has a demerit point system where a fully licenced (non-learner, non-probationary) driver is suspend when they accumulate",
        "answer": "15 points",
        "picture": ""
    },
    {
    ...
    {
        "id": 9,
        "question": "A \"parking lane\" as defined in the Basic License Driver's handbook is:",
        "answer": "That portion of a primary highway between the edge of the roadway to the right of the direction of a traffic and the nearest solid white line, not being the centre line, marked on the roadway",
        "picture": ""
    },
    {
        "id": 10,
        "question": "Should checking means:",
        "answer": "Glancing towards the blinds spot in the direction the driver intends to move",
        "picture": ""
    },
    {
        "id": 11,
    ...
    },
    {
        ...
        "answer": "Travel is not permitted in that line",
        "picture": "Q12.jpeg"
    },
    {
        "id": 13,
    ...
    {
        "id": 16,
        "question": "Under the Graduated Driver License program, a driver will receive 2 demerits:",
        "answer": "For having more passenger than there are seat belts",
        "picture": ""
    },
    {
        "id": 17,
    ...
    {
        "id": 21,
        "question": "According to the law in Alberta, it is the driver's responsibility to ensure that all passengers under what age properly retained in the vehicle?",
        "answer": "16 years",
        "picture": ""
    },
    {
        ...
        "answer": "50 centimeters from the curb",
        "picture": ""
    },
    {
        "id": 23,
        "question": "Who is responsible and legally obligated to report any condition, change in health, or physical disability that may affect a driver's ability to drive",
        "answer": "The driver",
        "picture": ""
    },
    {
    ...
    {
        "id": 27,
        "question": "Large \"X\" painted on the pavement indicates:",
    ...
    {
        "id": 32,
        "question": "A \"slow-moving vehicle\" sign must be displayed on the rear of any vehicle that normally travels at speed less than:",
        "answer": "40km/h",
        "picture": ""
    },
    {
    ...
    {
        "id": 40,
        "question": "When a driver's vehicle is approaching by an emergency vehicle sounding a siren, from any direction on a two-way road, the driver must:",
    ...
    {
        "id": 52,
        "question": "Under the Graduated Driver Licensing program, a learner with a Class 7 license is not permitted to drive a vehicle between the hours of:",
        "answer": "Midnight and 5:00 AM",
        "picture": ""
    },
    {
        "id": 53,
    ...
    {
        "id": 54,
        "question": "Unless other wise posted, the school zone speed limits are in effect on school days during the following hours:",
        "answer": "8:00 AM to 9:30 AM., 11:30 AM to 1:30 PM. and 3:00 PM to 4:30 PM",
        "picture": ""
    },
    {
        "id": 55,
    ...
    },
    {
        ...
        "answer": "Move into left lane if it is safe to do so, or be prepared to adjust speed",
        "picture": ""
    },
    {
        "id": 57,
        "question": "Which direction should a vehicle's front wheels be turned when park uphill on a two- way road with a curb?",
        "answer": "To the left",
        "picture": ""
    },
    {
        "id": 58,
        "question": "When approaching a rear of a stopped school bus that has its alternately flashing red lights activated, a driver must:",
    ...
    },
    {
        ...
        "answer": "From 8:30 AM to 1 hour after sunset",
        "picture": ""
    },
    {
        "id": 65,
    ...
    },
    {
        ...
        "answer": "When the vehicle has a proper identifying placard or license plate",
        "picture": ""
    },
    {
        "id": 69,
        "question": "At what minimum distance must headlight be dimed at night when approaching another vehicle from behind ?",
        "answer": "150 metres",
        "picture": ""
    },
    {
    ...
    {
        "id": 76,
        "question": "When facing Merge sign a driver should:",
    ...
    {
        "id": 77,
        "question": "In reduced viability due to fog, smoke or snow, use the:",
        "answer": "Headlights on low beam",
        "picture": ""
    },
    {
        "id": 78,
        "question": "This sign idicates:",
    ...
    },
    {
        ...
        "answer": "Yes, if the driver reduces speed and there is no traffic or pedestrian in the intersection, and no sign that prohibits such a such a turn",
        "picture": ""
    },
    {
        "id": 80,
        "question": "This sign indicates:",
        "answer": "Lane is reserved for use by the specifies vehicles",
        "picture": "Q80.jpeg"
    },
    {
        "id": 81,
        ...
        "answer": "Must not pass the vehicle. it is illegal",
        "picture": ""
    },
    {
        "id": 82,
    ...
    },
    {
        ...
        "answer": "Beginning 1 hour after sunseet and the ending 1 hour before the following sunrise",
        "picture": ""
    },
    {
        "id": 87,
    ...
    },
    {
        ...
        "answer": "Stop at least 5 meters from the nearest rail until the train has passed",
        "picture": ""
    },
    {
        "id": 90,
        "question": "The recommended method for traveling through a curve on a highway is:",
    ...
    {
        "id": 92,
        "question": "Why s it not safe to pass a loaded log-haul truck that is turning",
        "answer": "A danger zone exists as the the overhang of the logs from the tail end of the truck could block all the lanes on a highway during the turn",
        "picture": ""
    },
    {
        "id": 93,
